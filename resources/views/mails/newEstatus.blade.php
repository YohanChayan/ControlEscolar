                                                    ...
                                                    <tr>
                                                        <td style="width:300px;">
                                                            ...
                                                            <a href="{{route('home')}}" class="nav-item nav-link active">
                                                                <img height="auto" src="{{asset('custom/dashboard/img/logo_cucsh.png')}}" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="300" />
                                                            </a>
                                                            <hr>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                <tr>
                                                    <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:pointer;padding:15px 25px;" valign="middle">
                                                        <a href="{{route('home')}}" style="background:#0275d8;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                            Ingresar
                                                        </a>
                                                    </td>
                                                </tr>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                {{--Control Escolar--}} <br><br> {{--Csaba Kissi --}} <br><strong style="text-align:center;">Centro Universitario de Ciencias Sociales y Humanidades (CUCSH).</strong><br>
